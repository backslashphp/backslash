...
{{< callout context="note" title="Important note" icon="outline/info-circle" >}}
Backslash has been in continuous production for over seven years at
the [First Nations of Quebec and Labrador Health and Social Services Commission](https://cssspnql.com/en/). Although it
was initially developed to meet the organization’s specific needs, Backslash follows a generic event sourcing approach
that remains true to the core principles of the pattern.
{{< /callout >}}
